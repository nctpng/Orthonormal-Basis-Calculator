/* this is modified from our textbook on page 170 of the previous textbook*/
...
The program can theoretically handle matrices of any size but per the assignment instructions
...
I found it most convenient to pass arguments from a file (two examples included in submission):

    gcc taylor_pthread.cpp -o taylor_pthread -lm -lstdc++ -lpthread
    ./taylor_pthread $(cat args.txt)
...
To verify my answers, you can use https://www.emathhelp.net/calculators/linear-algebra/gram-schmidt-calculator
...
Two examples of linearly independent matrices (most matrices you try will be linearly dependent):
